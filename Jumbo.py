...
async def fun(ctx):
    em = discord.Embed(title=":joystick: | Fun Commands",description="`Fact`, `Truth`, `Dare`, `8ball`, `Opinion`, `Roast`, `Joke`, `Gayrate`, `IQ`, `Fight`, `Shoot`, `Trivia`",color=discord.Color.random())
    await ctx.send(embed=em)
